...
<head>
  <meta charset="utf-8">
  <title>Five advanced methods to rank highly in google search results | Blogpost @Obala</title>
  ...
  <div class="intro intro-single route bg-image" style="background-image: url(img/IMG_ld2j38.jpg)">
    ...
    <div class="intro-content display-table">
      <div class="table-cell">
        <div class="container">
          <h2 class="intro-title mb-4">SEO</h2>
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-8">
          <div class="post-box">
            <div class="post-thumb">
              <img src="blog-img/seo-for-beginners 2.jpg" class="img-fluid" alt="">
            </div>
            <div class="post-meta">
              <h1 class="article-title">Five advanced methods to rank highly in google search</h1>
              <ul>
                <li>
        ...
        <!---- comment form-->
            ...
            <form action="seo.php#suus" method="post" class="form-mf">
              <div class="row">
