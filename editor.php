        ...
        <div class="col-md-8">
          <div class="post-box">
            <div class="post-thumb">
              <img src="blog-img/code.jpg" class="img-fluid" alt="">
            </div>
            <div class="post-meta">
              <h1 class="article-title">Best Code Editors for Web development</h1>
              <ul>
                <li>
                  <span class="ion-ios-person"></span>
                  <a href="https://www.obala.ga/about..phpl">Obala Joseph Ivan</a>
                </li>
                <li>
